...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="admin_lottery_adds">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="start_time" data-validate="required:请输入标题" id="calen1" /><input type="text" class="input w50" value="" name="end_time" data-validate="required:请输入标题" id="calen2" />
                    <div class="tips"></div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <button class="button bg-main icon-check-square-o" type="submit"> 添加活动</button>
                </div>
            </div>
        </form>
    </div>
