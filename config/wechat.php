...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx426b3015555a46be'),         // AppID
    'secret'  => env('WECHAT_SECRET', '7813490da6f1265e4901ffb80afaa36f'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', '1900009851'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', '8934e7d15453e97507ef794cf7b0519d'),                    // EncodingAESKey
